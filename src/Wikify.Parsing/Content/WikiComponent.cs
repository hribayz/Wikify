...
namespace Wikify.Parsing.Content
{
    public class WikiComponent : IWikiComponent
    {
        ...
        protected LinkedList<WikiComponent> _children { get; private set; }
        ...
        internal void AddChildren(LinkedListNode<WikiComponent> wikiComponents)
        {
        ...
        public WikiComponent(WikiComponentType componentType, Node startNode, Node endNode)
        {
            ...
            _children = new LinkedList<WikiComponent>();
        }
